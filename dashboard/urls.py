...
urlpatterns = [
    ...
    path('dashboard/category/<int:category_id>/edit/', views.EditCategoryView.as_view(), name='edit_category'),
    ...
    path('dashboard/manufacturers/<int:manufacturer_id>/edit/', views.EditManufacturerView.as_view(), name='edit_manufacturer'),
    ...
    path('dashboard/edit_product_type/<int:drug_type_id>/', views.EditProductTypeView.as_view(), name='edit_product_type'),
    ...
    path('dashboard/edit_news/<int:new_id>/', views.EditNewsView.as_view(), name='edit_news'),
    path('delete_news/<int:new_id>/', views.DeleteNewsView.as_view(), name='delete_news'),
    path('update-history/<int:new_id>/', views.UpdateHistoryView.as_view(), name='update_history'),
